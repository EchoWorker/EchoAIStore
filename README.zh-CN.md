...
<p align="center">
  <img src="images/echowork-capability-matrix.zh-CN.png" alt="EchoWork 能力矩阵：多 Workspace、多工作流并行、过程可控、持续工作与 HTML Apps" width="1200" />
</p>

## EchoWork 有什么不同？

**EchoWork 不是又一个 AI 聊天窗口，而是一套面向真实工作的 AI 工作台。** 它以 AI 重塑个人的工作带宽，让多项任务得以并行推进、持续运转并始终处于掌控之中，将个人生产力从单线执行提升为多线协同。
...
| **Channels 外部入口** | 通过连接器接入微信、Slack、Webhook 等外部请求，并在 EchoWork 中继续管理和处理对应 Sessions。 |
...
HTML App 是 EchoWork 区别于普通 AI 工作台的重要能力。用户只需描述目标，Agent 就可以在 Workspace 中创建一个交互界面，并让它调用 AI、读取和整理文件、保存状态、展示数据。
...
前往 [最新版本页面](https://github.com/EchoWorker/EchoAIStore/releases/tag/echowork-latest)，下载适用于 **Windows x64** 或 **macOS Apple Silicon** 的安装包。正式版已经内置 EchoAI，无需额外部署服务。
...
[提交问题或功能建议](https://github.com/EchoWorker/EchoAIStore/issues) · [查看最新版本](https://github.com/EchoWorker/EchoAIStore/releases/tag/echowork-latest)

EchoWork 采用 [AGPL-3.0-or-later](https://github.com/EchoWorker/EchoWork/blob/main/LICENSE) 许可证。
